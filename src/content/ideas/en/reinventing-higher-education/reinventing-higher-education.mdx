...
1. Youths from disadvantaged economic backgrounds have a chance at proving themselves and thriving.
2. Many paths of life thats wouldn't have crossed before now converge and interlock. Diversity is part of the "club".
3. Social connections are created between working professionals and students, paving the way for future ventures.
4. Innovation, problem-solving and creation as work-skills join the market, helping the country and region solve its most pressing issues.
5. If the idea is successful, and we manage to create these amazing people and gather prestige, then this can be a success example for others to create similar institutions in Colombia and the world over, changing education as we know it. This can force/inspire other more traditional institutions to change, this can create a push for more modern methods in daycare, middle-school and high-school, this can create change in legislation.
