...
tags:
  ...
  - innovation
description:
  How child-like lateral-thinking can drive inventiveness.
---
...
People in the tech bubble are often wondering how this magic comes about <input type="checkbox" id="cb2" /><label for="cb2"><sup></sup></label><span><br><br>After proof-reading, this reminded me of ["We the Possibility"](https://www.wethepossibility.com/) by Mitchell Weiss, a great book on how to innovate in environments where innovation itself is thought an impossibility. </br></br></span>, and most likely even began their careers through that same curiosity that drives children: The drive to try and understand the world through the lens of the uninitiated. Through that path lies the learning of how to use some subset of technology.
