...
That little ugly landing page was a failure as a sales generator, but it got me learn the bare basics of HTML, CSS, Typescript, and React. I could now call myself a noob at Frontend, but not a complete ignorant.

Over the following ~5 years I would continue to learn more about both Python and Typescript in parallel. I contributed greatly to all parts of our stack, and I became ok at Typescript (both Frontend and Backend), pretty good at Python for backend and I dare say a great Data Scientist. I've also had the opportunity to learn about DevOps to a small degree.
